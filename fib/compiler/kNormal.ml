...
let knormal_debug oc l =
       ...
       (print_tab level;
        ...
        | IfEq (e1, e2, e3, e4) ->
            (Printf.fprintf oc "IfEq\n";
             ...
             print_tab (level+1);
             Printf.fprintf oc "%s\n" e2;
             print_knormal e3 (level+1);
             print_knormal e4 (level+1))
        | IfLE (e1, e2, e3, e4) ->
        ...
        | Let ((id, t), e1, e2) ->
            (Printf.fprintf oc "Let\n";
             ...
             print_id_type (id, t);
             Printf.fprintf oc "\n";
             print_knormal e1 (level+1);
             print_knormal e2 (level+1))
        | Var id ->
    ...
    and print_fundef fundef level =
       (print_tab level;
        ...
        print_knormal fundef.body (level+1))
