...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L sim_clk_gen_v1_0_2 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fib_sim xil_defaultlib.fib_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fib_sim -key {Behavioral:sim_1:Functional:fib_sim} -tclbatch cmd.tcl -protoinst "protoinst_files/fib_sim.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fib_sim.wdb xsim.dir)
