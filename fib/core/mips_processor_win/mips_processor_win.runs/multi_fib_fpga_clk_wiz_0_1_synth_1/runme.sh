...
HD_PWD='C:/mips_processor_win/mips_processor_win.runs/multi_fib_fpga_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_fib_fpga_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_fib_fpga_clk_wiz_0_1.tcl
