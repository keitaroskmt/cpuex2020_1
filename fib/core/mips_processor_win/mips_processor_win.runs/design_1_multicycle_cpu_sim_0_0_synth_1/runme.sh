...
HD_PWD='C:/mips_processor_win/mips_processor_win.runs/design_1_multicycle_cpu_sim_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_multicycle_cpu_sim_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_multicycle_cpu_sim_0_0.tcl
