...
################################################################
# This is a generated script based on design: multi_cycle_fib
#
...
# source multi_cycle_fib_script.tcl
...
set design_name multi_cycle_fib
...
proc create_root_design { parentCell } {
  ...
  set block_cell_name multicycle_cpu_0
  if { [catch {set multicycle_cpu_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $multicycle_cpu_0 eq "" } {
