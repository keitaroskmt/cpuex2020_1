...
HD_PWD='C:/Users/nowi74/cpuex2020_1/fib/core/mips_processor_fib/mips_processor_fib.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_cycle_fib_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_cycle_fib_wrapper.tcl
