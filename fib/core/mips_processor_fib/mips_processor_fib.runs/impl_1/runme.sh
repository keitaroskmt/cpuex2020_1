...
HD_PWD='C:/Users/nowi74/cpuex2020_1/fib/core/mips_processor_fib/mips_processor_fib.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_cycle_fib_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_cycle_fib_wrapper.tcl -notrace
