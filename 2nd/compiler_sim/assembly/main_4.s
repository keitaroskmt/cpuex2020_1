...
bgti_cont.20452:
	...
	lw	%ra, 72(%sp)
	lw	%v0, 56(%sp)
	blt	%zero, %v0, bgt_else.20463
	jr	%ra
bgt_else.20463:
	addi	%v0, %v0, -1
	blt	%zero, %v0, bgt_else.20465
	j	bgt_cont.20466
bgt_else.20465:
	lw	%v0, 71(%sp)
	lw	%v1, 1(%sp)
