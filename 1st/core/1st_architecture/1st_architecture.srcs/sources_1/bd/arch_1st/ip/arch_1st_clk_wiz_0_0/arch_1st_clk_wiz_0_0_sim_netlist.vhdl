...
-- Date        : Thu Nov  5 01:06:24 2020
-- Host        : LAPTOP-G1I2TTIP running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top arch_1st_clk_wiz_0_0 -prefix
--               arch_1st_clk_wiz_0_0_ arch_1st_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : arch_1st_clk_wiz_0_0
...
entity arch_1st_clk_wiz_0_0_arch_1st_clk_wiz_0_0_clk_wiz is
  port (
...
end arch_1st_clk_wiz_0_0_arch_1st_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of arch_1st_clk_wiz_0_0_arch_1st_clk_wiz_0_0_clk_wiz is
  signal clk_in1_arch_1st_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_arch_1st_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_arch_1st_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => clk_out1_arch_1st_clk_wiz_0_0,
      O => clk_out1
    );
mmcme3_adv_inst: unisim.vcomponents.MMCME3_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_arch_1st_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme3_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_arch_1st_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity arch_1st_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of arch_1st_clk_wiz_0_0 : entity is true;
end arch_1st_clk_wiz_0_0;

architecture STRUCTURE of arch_1st_clk_wiz_0_0 is
begin
inst: entity work.arch_1st_clk_wiz_0_0_arch_1st_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
